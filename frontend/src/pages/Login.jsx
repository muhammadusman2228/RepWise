...
const Login = () => {
  ...
  return (
    <div
      className="min-h-screen bg-[#f6f8fb] bg-cover bg-center text-[#14171f] lg:grid lg:grid-cols-[minmax(0,1fr)_480px]"
      style={{
    ...
    >
      ...
      >
        <div className="absolute inset-x-0 bottom-0 p-10 text-white">
          ...
          <h1 className="max-w-lg text-4xl font-semibold">Training data that feels easy to keep.</h1>
          <p className="mt-4 max-w-md text-sm leading-6 text-white/80">
            Track your sessions, review progress, and keep the next workout clear.
          </p>
        </div>
      </section>
      ...
      <main className="flex min-h-screen items-center justify-center px-4 py-10 sm:px-6">
        <section className="w-full max-w-md rounded-lg border border-[#dfe5ec] bg-white p-6 shadow-sm sm:p-8">
          <div className="mb-8">
            ...
            <h2 className="text-3xl font-semibold text-[#14171f]">Welcome back</h2>
          ...
          <p className="mt-8 text-center text-sm text-[#687385]">
            New to RepWise?{" "}
            <Link to="/register" className="font-semibold text-[#0f766e] hover:text-[#115e59]">
              Create an account
            </Link>
          </p>
        </section>
